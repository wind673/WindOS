...
/* 全局变量定义 --------------------------------------------------------------*/
/* App --------------------------------------------*/
Type_AppList AppHead[OS_THREAD_MAX] = {NULL}; //定义任务堆头       
...
{  
	...
	Type_AppList *Temp = &AppHead[_AppList ->thread];   
...
返回值 ：0.成功
------------------------------------------------------------------------------*/
inline uint8_t OSTask_State(Type_AppList *_AppList,Type_OS_State _State)  
{      			 	
	/* 修改数据 -----------------------------------*/		 	
...
返回值 ：0.成功
------------------------------------------------------------------------------*/
inline uint8_t OSTask_Close(Type_AppList *_AppList)  
{      
	/* 修改数据 -----------------------------------*/		 	
...
返回值 		：0.成功
------------------------------------------------------------------------------*/
inline uint8_t OSTask_Active(Type_AppList *_AppList)  
{      
	/* 修改数据 -----------------------------------*/		 	
...
返回值 		：0.成功
------------------------------------------------------------------------------*/
inline uint8_t OSTask_Sleep(Type_AppList *_AppList,uint32_t Sleep)  
{      
	/* 修改数据 -----------------------------------*/		 	
