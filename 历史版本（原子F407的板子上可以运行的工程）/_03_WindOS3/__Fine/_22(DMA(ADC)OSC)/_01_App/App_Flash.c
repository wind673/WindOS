...
{ 		
	OS_String_Show(FONT_3*3,FONT_3*2,(u8*)"Flash",FONT_3,0);							
	
	OS_String_Show(FONT_1,FONT_3*4,(u8*)"FlashSend:",FONT_2,0);	
	OS_String_Show(FONT_1,FONT_3*5,SendBuff,FONT_2,0);		
//	OS_Num_Show(FONT_1,FONT_3*5,SendBuff[0],3,FONT_2,0);	
											
	OS_String_Show(FONT_1,FONT_3*7,(u8*)"FlashReceive:",FONT_2,0);	
	OS_String_Show(FONT_1,FONT_3*8,ReceiveBuff,FONT_2,0);		
//	OS_Num_Show(FONT_1,FONT_3*8,ReceiveBuff[0],3,FONT_2,0);			
	return 0; 		
}	
...
Type_AppList APP_Flash = {Flash_Main,NULL,Flash_Start,Flash_End, \
							...
							(u8*)"Flash",200,USE_OS_ICO,gImage_IcoFlash};			
