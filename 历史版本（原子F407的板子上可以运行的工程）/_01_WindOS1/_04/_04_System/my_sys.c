...
void Drive_Init(void)
{
	...
	//系统关键初始化
	//=======================================================================
	NVIC_PriorityGroupConfig(NVIC_PriorityGroup_2);//终端组3||3位抢占2位响应优先级 
...
//{
//	IRQ_TIM2_Configuration();
//	 __Timer=0;	
//}


//void _delay_us(u32 t)
//{
//	__Timer=0;__Timer_Scop=t;
//	if(__Timer_Scop<=65000) 
//	{
//	TIM_Cmd(TIM2,ENABLE);
//	while(!__Timer_Tag);
//	TIM_Cmd(TIM2,ENABLE);
...
////65ms内精确延时
//void _delay_ms(u32 t)
//{
//	
//	__Timer=0;__Timer_Scop=t*1000;
//	if(__Timer_Scop>65000) 
//	while(__Timer_Scop--)	_delay_us(1);
//	
//	if(__Timer_Scop<=65000) 
//	{
//	TIM_Cmd(TIM2,ENABLE);
...
//=========================================================================
	...
	RCC_PCLK2Config(RCC_HCLK_Div1);//设置APB2不分频  用于ADC
