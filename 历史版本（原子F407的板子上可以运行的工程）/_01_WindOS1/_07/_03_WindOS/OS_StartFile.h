...
/* prioity ------------------------------*/
#define THREAD_FREE  	     254  //空闲线程
#define THREAD_SYSTEM  	     4	  //线程4 系统线程
#define THREAD_PRIMARY 	 	 7	  //线程7 主线程  
#define THREAD_6  	      	 6	  //线程6
#define THREAD_5  	    	 5	  //线程5 
#define THREAD_3  	    	 3	  //线程3
#define THREAD_2  	     	 2	  //线程2
#define THREAD_1  	     	 1	  //线程1 
#define THREAD_0  	     	 0	  //线程0 
#endif
/*******************************(C) COPYRIGHT 2016 Wind（谢玉伸）*********************************/
