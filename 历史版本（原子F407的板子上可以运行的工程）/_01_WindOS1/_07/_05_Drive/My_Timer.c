...
/*---------------------------------------------------------------------------------------------*/
	...
	TIM_TimeBaseStructure.TIM_Period =TIME_SLICE-1;//重装载值
...
/*---------------------------------------------------------------------------------------------*/	
	...
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority= THREAD_PRIMARY ; //抢占优先级 7
...
/*---------------------------------------------------------------------------------------------*/
	...
	TIM_ITConfig(TIM4,TIM_IT_Update,ENABLE);//允许定时器9更新中断							//@
...
/*---------------------------------------------------------------------------------------------*/	
	...
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority= THREAD_SYSTEM ; //抢占优先级 4
	NVIC_InitStructure.NVIC_IRQChannelSubPriority= 1 ; //响应优先级 0
	NVIC_InitStructure.NVIC_IRQChannelCmd=ENABLE;
	NVIC_Init(&NVIC_InitStructure);// 初始化 NVIC
