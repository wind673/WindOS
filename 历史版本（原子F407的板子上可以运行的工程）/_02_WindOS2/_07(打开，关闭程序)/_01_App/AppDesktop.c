...
{  
	...
	if(_cnt%100 == 0)
	OS_Button_Creat(OS_LCD_WHITH - FONT_3,FONT_2,OS_LCD_WHITH,FONT_1+FONT_3,(u8*)"×",FONT_3,RED);	
	
	if(TouchPoint._X > OS_LCD_WHITH - FONT_3&&TouchPoint._X < OS_LCD_WHITH&&TouchPoint._Y>FONT_2&&TouchPoint._Y<FONT_1+FONT_3) 
	{ 
