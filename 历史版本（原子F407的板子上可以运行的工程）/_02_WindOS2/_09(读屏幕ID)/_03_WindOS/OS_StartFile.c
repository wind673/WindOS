...
{		 
	...
	/* WindOS初始化 ------------------------------------*/  		
	OSTask_Creat(APP_TouchScan,(u8*)"APP_Touch.wos",20,OS_STATE_ACTIVE,OS_THREAD_SYSTEM);   			
	OSTask_Creat(AppTaskbar,(u8*)"AppTaskbar.wos",20,OS_STATE_ACTIVE,OS_THREAD_SYSTEM);  			
	OSTask_Creat(App_Desktop,(u8*)"App_Desktop.wos",100,OS_STATE_ACTIVE,OS_THREAD_PRIMARY); 	
